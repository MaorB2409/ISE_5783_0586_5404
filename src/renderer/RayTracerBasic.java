...
public class RayTracerBasic extends  RayTracerBase{
    ...
    public Color traceRay(Ray ray) {
        Intersectable.GeoPoint intersection = ray.findClosestGeoPoint(scene.getGeometries().findGeoIntersections(ray));//all intersection points wit the ray
        //if no intersection return background color
        return intersection == null ? scene.getBackground() : calcColor(intersection, ray);
    }
