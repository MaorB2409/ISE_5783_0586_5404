...
class IntegrationTest {
    ...
    @Test
    public void cameraRayTriangleIntegration() throws IllegalAccessException {
    ...
    public void cameraRaySphereIntegration() {
        ...
        assertCountIntersections(cam1, new Sphere(new Point(0, 0, -3), 1), 2,"TC01");
        ...
        assertCountIntersections(cam2, new Sphere(new Point(0, 0, -1), 4), 9,"TC04");

        // TC05: Beyond Sphere 0 points
        assertCountIntersections(cam1, new Sphere(new Point(0, 0, 1), 0.5), 0,"TC05");
    }
