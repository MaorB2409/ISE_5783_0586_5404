    ...
    public void twoSpheresOnMirrors() throws IllegalAccessException {
        ...
        scene.getGeometries().add( //
                ...
                new Triangle(new Point(1500, -1500, -1500), new Point(-1500, 1500, -1500),
                        ...
                        .setMaterial(new Material().setKr(1).setGlossy(0.9)),
                new Triangle(new Point(1500, -1500, -1500), new Point(-1500, 1500, -1500),
                        new Point(-1500, -1500, -2000)) //
                        .setEmission(new Color(20, 20, 20)) //
                        .setMaterial(new Material().setKr(new Double3(0.5, 0, 0.4)).setGlossy(0.9)));
    ...
    public void trianglesTransparentSphere() throws IllegalAccessException {
        ...
        scene.getGeometries().add( //
                ...
                new Sphere(new Point(60, 50, -50), 30d).setEmission(new Color(BLUE)) //
                        .setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30).setKt(0.6).setGlossy(0)));
