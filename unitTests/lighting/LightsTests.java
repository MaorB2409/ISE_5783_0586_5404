...
public class LightsTests {
    ...
    private Scene scene3 = new Scene.SceneBuilder("Test scene").build();
    ...
    public void sphereCombined() {
        ...
        scene1.getGeometries().add(sphere);
        scene1.getLights().add(new DirectionalLight(new Color(255,0,0), new Vector(0.5, 0, -1)));
        scene1.getLights().add(new PointLight(new Color(192,192,192), spPL1).setKl(0.000001).setKq(0.0001));
        scene1.getLights().add(new SpotLight(new Color(205,127,50), spPL2, new Vector(1, 1, -0.5)).setKl(0.000001).setKq(0.000001));
    ...
    public void trianglesCombined() {
        ...
        scene2.getLights().add(new PointLight(trCL, trPL1).setKl(0.001).setKq(0.0002));
        scene2.getLights().add(new SpotLight(trCL, trPL2, trDL).setKl(0.001).setKq(0.0001));
    ...
    public void TubeTest() {
        ...
        Point trPL1 = new Point(50, -80, -80);
        Point trPL2 = new Point(20, -20, 15);
        scene3.getGeometries().add(tube1);
        scene3.getLights().add(new DirectionalLight(trCL, trDL));
        scene3.getLights().add(new PointLight(trCL, trPL1).setKl(0.001).setKq(0.0002));
        scene3.getLights().add(new SpotLight(trCL, trPL2, trDL).setKl(0.001).setKq(0.0001));
